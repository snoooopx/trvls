    ...
    exit;*/
               $result = array();
                ...
                if($pagesinfo->content_special == '1'){
                  ...
                  $arrayFrom = array("ean","flightsdohop","cartrawler","travelstart","hotelscombined","wegoflights","travelpayouts");
                  $arrayTo = array("properties","flightsd","car","flightst","hotelsc","flightsw","flight");
