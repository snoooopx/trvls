<style>
   body { width: 100%; height: 100%; background: rgb(90,113,155); background: -moz-linear-gradient(45deg, rgba(90,113,155,1) 0%, rgba(83,109,155,1) 20%, rgba(57,92,160,1) 44%, rgba(1,37,114,1) 82%); background: -webkit-linear-gradient(45deg, rgba(90,113,155,1) 0%,rgba(83,109,155,1) 20%,rgba(57,92,160,1) 44%,rgba(1,37,114,1) 82%); background: linear-gradient(45deg, rgba(90,113,155,1) 0%,rgba(83,109,155,1) 20%,rgba(57,92,160,1) 44%,rgba(1,37,114,1) 82%); filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#5a719b', endColorstr='#012572',GradientType=1 ); }
    ...
    <form method="POST" action="" id="loginfrm" accept-charset="UTF-8" onsubmit="return false;">
      ...
      <div class="clearfix"></div>
        <div data-wow-duration="1s" data-wow-delay="1s" class="wow fadeIn">
          ...
          <button style="margin-top: -16px; border-radius: 0px;" type="submit" class="btn btn-action btn-block loginbtn"><?php echo trans('04');?></button>
        </div>
        <div class="wow zoomInDown animated">
          <?php if($registerationAllowed == "1"){ ?>
          <div class="left"><a href="<?php echo base_url();?>register" style="color:white"><span></span><?php echo trans('0237');?></a></div>
          <?php } ?>
          <div class="right"><a data-toggle="modal" href="#ForgetPassword" style="color:white"><?php echo trans('0112');?></a></div>
        </div>
      <!-- End of Login Wrap  -->
    </form>
  </div>
