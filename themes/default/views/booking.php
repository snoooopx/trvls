        ...
        <div class="bookingside">
          ...
          <div class="hpadding30">
            ...
            <img class="img-responsive" src="<?php echo $module->thumbnail;?>" alt="<?php echo $module->title;?>" />
                  ...
                  <div class="clearfix"></div>
                  <div class="size13 grey RTL go-right"><i class="fa fa-map-marker RTL"></i> <?php echo $module->location;?></div>
                  <div class="clearfix"></div>
              ...
              <div class="row">
                ...
                <div style="margin-top: -30px;;padding-bottom:15px">
                  <span class="pull-right lred2 bold fs30">  <strong><?php echo $room->currCode;?> <?php echo $room->currSymbol;?><span id="displaytotal"><?php echo $room->price;?></span></strong></span>
                  <div class="clearfix"></div>
                </div>
                <?php } ?>
